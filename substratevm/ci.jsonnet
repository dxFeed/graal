{
  ...
  builds: [
    ...
    linux_amd64_jdk17 + gate("style-fullbuild", "style,fullbuild,helloworld,test,test_build_time_eval,svmjunit,debuginfotest") + common.eclipse + common.jdt + maven + jsonschema + svm_unittest + t("50:00") + mx_build_exploded + gdb("10.2"),
